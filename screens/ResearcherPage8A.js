      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.frame}>
          ...
          <ScrollView style={styles.textScroll}>
            ...
            <Text style={styles.textContent}>
              I chose to send messages for {selectedMessages} days
            </Text>
            <Text style={styles.textContent}>
              I chose to send {selectedMessagesPerDay} messages a day at random times in the following ranges:
            </Text>
...
export default ResearcherPage8A;
